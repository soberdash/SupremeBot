module.exports = async (client, message, args) => {
    ...
    if(!args[0]){
      ...
      try {
        const reloadedCmd = require(`/home/jeffrey/sb/comandos/${nameCmd}.js`);
        ...
        delete require.cache[require.resolve(`/home/jeffrey/sb/comandos/${nameCmd}.js`)];
      } catch (error) {
        console.log(error);
        message.channel.send(`<a:ani_no:709633289106882590> Ha ocurrido un error al reiniciar el comando \`${nameCmd}\` (Posibles razones: El comando introducido no existe. Para más información revisa la consola)`);
      }  
    }
  }